	...
	if ( ! class_exists( 'WC_List_Grid' ) ) {
		...
		class WC_List_Grid {
			...
			function gridlist_toggle_button() {
				...
				// $output = sprintf( '<nav class="gridlist-toggle" style="display:none"><a href="#" id="grid" title="%1$s"><span class="dashicons dashicons-grid-view"></span> <em>%1$s</em></a><a href="#" id="list" title="%2$s"><span class="dashicons dashicons-exerpt-view"></span> <em>%2$s</em></a></nav>', $grid_view, $list_view );
			...
			function gridlist_set_default_view() {
				$default = get_theme_mod( 'wc_glt_default_format', 'list' );
				?>
					<script>
